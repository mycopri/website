...
<div id="wrapper">
  <div id="container" class="clear-block">
    ...
    <div id="header">
      ...
      <?php if ($search_box && !user_is_anonymous()): ?>
      <div class="block block-theme" style="padding-top: 50px; color: white; float: right;"><?php print $search_box ?></div>
      <?php endif; ?> 
    </div>
    <!-- /header -->
