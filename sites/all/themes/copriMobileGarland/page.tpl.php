	...
	<div id="container">
		...
		<div id="header" class="mobileregion">
			...
			if ($logo) {
				...
				print '	<div id="headerLogo"><a id="sitelogo" title="' . $site_slogan . '" href="' . check_url($front_page) . '"><img src="'. check_url($logo) .'" /></a></div>';
			}
			if ($site_name) {
				print '<div id="headerName"><h1 id="sitename"><a title="' . $site_slogan . '" href="' . check_url($front_page) . '"><span>' . $site_name . '</span></a></h1></div>';
			}
			?>
		</div>
