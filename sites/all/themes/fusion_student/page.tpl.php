<?php
// $Id: page.tpl.php 6555 2010-02-24 20:21:15Z chris $
...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">  
  <div id="page" class="page">
    ...
    <!-- custom student days header: width = grid_width -->
    <div id="header-group" class="header-group row <?php print $grid_width; ?>">
      <div class="student_header" >
        <!-- <img class="header-logo" src="http://ci-asce.org/home/sites/all/themes/fusion_student/images/CI_logo.png" height="200"
        style="position: absolute; top: 210px; left: 225px;"></img> -->
        ...
        <div id="header-group-inner" class="header-group-inner inner clearfix">
          ...
          <div id="header-site-info" class="header-site-info block">
            <div id="header-site-info-inner" class="header-site-info-inner inner clearfix">
              ...
              <?php if ($logo): ?><div id="site-name-wrapper"><?php endif; ?>
              <span id="site-name"><a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></span>
              <?php if ($site_slogan): ?>
              <span id="slogan"><?php print $site_slogan; ?></span>
              <?php endif; ?>
              <?php if ($logo): ?></div><?php endif; ?>
              <?php endif; ?>
    ...
    <div id="page-inner" class="page-inner">
      ...
      <div id="main-wrapper" class="main-wrapper full-width">
        <div id="main" class="main row fill_header <?php print $grid_width; ?>">
      ...
      <div id="footer-wrapper" class="footer-wrapper <?php print $grid_width; ?> row clearfix">
        <div id="footer-wrapper-inner" class="footer-wrapper-inner">
